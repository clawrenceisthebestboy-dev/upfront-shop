...
def delete_job(conn, jid: int) -> None:
    """Hard delete. Used when a cash-paid invoice is closed out.
    Cash sales are tracked externally (printed invoice kept in the safe)
    per shop policy. Cascades to line_items via FK."""
