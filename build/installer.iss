...
; The big cartoon that John sees on the Welcome / Finished pages of the installer.
; Inno Setup accepts a comma-separated list of bitmaps at different sizes and
; picks the right one for the monitor DPI. BMPs live next to this .iss file.
