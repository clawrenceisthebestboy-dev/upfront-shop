...
hidden = (
    ...
    # cryptography loads backends via cffi — PyInstaller's static analyzer
    # doesn't see them, so bundle the whole package explicitly.
...
a = Analysis(
    ...
    pathex=[".."],
    binaries=[],
    # Ship the resources/ folder next to the exe so the logo and any
    # other bundled assets are reachable via db.bundled_resource_dir().
